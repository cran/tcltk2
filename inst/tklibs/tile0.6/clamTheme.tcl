#
# $Id: clamTheme.tcl,v 1.20 2005/04/11 01:53:59 jenglish Exp $
#
...
namespace eval tile::theme::clam {
	...
	style default TMenubutton -width -11 -padding 5 -relief raised
	...
	style map TNotebook.Tab \
    	...
    	style default TLabelframe -labeloutside true

	style default TProgress -background $colors(-frame)
	style default TProgressbar -background $colors(-frame)

	style default Sash -sashthickness 6 -gripcount 10
    }
}
