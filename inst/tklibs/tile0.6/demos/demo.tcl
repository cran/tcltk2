#
# $Id: demo.tcl,v 1.91 2005/03/27 19:04:36 jenglish Exp $
#
...
set client [ttk::frame $nb.client]
$nb add $client -text "Demo" -underline 0

if {0} {
set l [ttk::labelframe $client.styled -text "Themed" -padding 6 -underline 1]
set r [labelframe $client.orig -text "Standard" -padx 6 -pady 6]
grid $l $r -sticky news -padx 6 -pady 6
grid rowconfigure $client 0 -weight 1
grid columnconfigure $client {0 1} -weight 1
} else {
set pw [ttk::paned $client.pw -orient horizontal]
pack $pw -expand true -fill both -padx 6 -pady 6
...
proc scales.pane {scales} {
    ...
    ttk::scale $l.vscale -orient vertical -from -25 -to 25 -variable ::V(VSCALE)
    ttk::progressbar $l.progress -orient horizontal -maximum 100 
    ttk::progressbar $l.vprogress -orient vertical -maximum 25
    if {1} {
    ...
    ##
    grid $l $r -sticky nwes -padx 6 -pady 6
    grid columnconfigure $scales 0 -weight 1
    grid columnconfigure $scales 1 -weight 1
    grid rowconfigure $scales 0 -weight 1

    return $scales
}
$nb add [scales.pane $nb.scales] -text Scales -sticky nwes
...
proc showHelp {} { tk_messageBox -message "No help yet..." }
