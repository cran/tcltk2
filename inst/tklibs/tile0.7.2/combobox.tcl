#
# $Id: combobox.tcl,v 1.28 2005/09/29 02:32:06 jenglish Exp $
#
...
#
# PhG: added topmost attributes to allow displayed comboboxes correctly
# inside topmost windows!
...
proc tile::combobox::PopdownShell {cb} {
    ...
    if { [regexp topmost [wm attributes $popdown]] == 1 } {
